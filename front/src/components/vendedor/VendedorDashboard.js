...
const VendedorDashboard = () => {
  return (
    <Container>
      <Row className="my-4">
        <Col>
          <h1 className="text-center" style={{ color: '#0A74DA' }}>Panel de Vendedor</h1>
        </Col>
      </Row>
      <Row>
        <Col md={6}>
          <Card className="mb-4" style={{ borderColor: '#d1d1d1', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
            <Card.Body className="text-center">
              ...
              <Button href="/vendedor/users" variant="outline-primary" style={{ backgroundColor: '#0A74DA', color: '#fff' }}>Ver usuarios</Button>
            </Card.Body>
          </Card>
        </Col>
        <Col md={6}>
          <Card className="mb-4" style={{ borderColor: '#d1d1d1', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
            <Card.Body className="text-center">
              ...
              <Button href="/admin/sellers" variant="outline-primary" style={{ backgroundColor: '#0A74DA', color: '#fff' }}>Ver vendedores</Button>
            </Card.Body>
          </Card>
        </Col>
      </Row>
